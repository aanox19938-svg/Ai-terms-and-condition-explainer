      ...
      <div className="flex flex-col lg:flex-row items-center justify-between gap-6 relative z-10">
        ...
        <div className="flex items-center space-x-6 w-full lg:w-auto">
          ...
          <div className="translate-z-6">
            ...
            <h3 className="text-xl sm:text-2xl font-bold text-white tracking-tight">{document.file_name}</h3>
            <p className="text-xs sm:text-sm text-slate-400 mt-1">{style.title}</p>
          </div>
        </div>
