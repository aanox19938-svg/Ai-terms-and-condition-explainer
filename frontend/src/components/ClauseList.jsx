      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 pb-5 border-b border-white/10">
        ...
        <div className="relative w-full md:w-64">
          ...
          <input
            ...
            className="w-full bg-black/35 border border-white/10 rounded-xl pl-10 pr-3.5 py-2 text-xs text-slate-200 placeholder-slate-500 focus:outline-none focus:border-cyan-400 focus:ring-2 focus:ring-cyan-500/20 transition-all"
          />
        </div>
      </div>
        ...
        {filteredClauses.length === 0 ? (
          ...
          filteredClauses.map((item, idx) => (
            <div
              ...
              className={`rounded-2xl border p-5 sm:p-6 transition-all duration-300 hover:scale-[1.005] ${
                item.risk_level === 'High'
                  ? 'bg-rose-950/20 border-rose-500/30 hover:border-rose-500/50 shadow-[0_0_20px_rgba(244,63,94,0.08)]'
                  : item.risk_level === 'Medium'
                  ? 'bg-amber-950/20 border-amber-500/30 hover:border-amber-500/50 shadow-[0_0_20px_rgba(245,158,11,0.08)]'
            ...
            >
              ...
              <div className="mt-3.5 text-xs sm:text-sm text-slate-200 leading-relaxed bg-black/40 p-4 rounded-xl border border-white/10">
